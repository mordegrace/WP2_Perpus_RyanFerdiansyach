        ...
        <div class="col-12">
            <div class="card mb-3" style="max-width: 54rem;">
                <div class="row no-gutters">
                    ...
                    foreach ($buku as $b) { ?>
                    <div class="col-md-4">
                        <img class="card-img" alt="..." src="<?= base_url('assets/img/upload/') . $b['image']; ?>">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('buku/ubahBuku'); ?>" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control formcontrol-user" id="judul_buku"
                                        name="judul_buku" placeholder="Masukkan Judul Buku"
                                        value="<?= $b['judul_buku']; ?>">
                                </div>

                                <div class="form-group">
                                    <select name="id" class="custom-select form-control-user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control formcontrol-user" id="penerbit"
                                ...
                                <div class="form-group float-right mt-3">
                                    <a href="<?= base_url('buku'); ?>" class="btn btn-secondary"><i
                                            class="fas fa-ban"></i> Batal</a>
